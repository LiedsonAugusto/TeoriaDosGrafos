...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dijkstra2 = MeuGrafo(['A', 'B', 'C', 'D', 'E', 'F'])
        self.dijkstra2.adicionaAresta('a1', 'A', 'B', 1)
        self.dijkstra2.adicionaAresta('a2', 'B', 'E', 1)
        self.dijkstra2.adicionaAresta('a3', 'A', 'C', 2)
        self.dijkstra2.adicionaAresta('a4', 'C', 'D', 2)
        self.dijkstra2.adicionaAresta('a5', 'D', 'F', 2)

        self.dijkstra3 = MeuGrafo(['A', 'B', 'C', 'D', 'E', 'F'])
        self.dijkstra3.adicionaAresta('a1', 'A', 'B', 1)
        self.dijkstra3.adicionaAresta('a2', 'A', 'C', 2)
        self.dijkstra3.adicionaAresta('a3', 'B', 'D', 2)
        self.dijkstra3.adicionaAresta('a4', 'C', 'E', 1)
        self.dijkstra3.adicionaAresta('a5', 'D', 'F', 2)

        self.dijkstra4 = MeuGrafo(['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K'])
        self.dijkstra4.adicionaAresta('a1', 'A', 'B', 1)
        self.dijkstra4.adicionaAresta('a2', 'A', 'C', 1)
        self.dijkstra4.adicionaAresta('a3', 'A', 'D', 3)
        self.dijkstra4.adicionaAresta('a4', 'A', 'E', 1)
        self.dijkstra4.adicionaAresta('a5', 'E', 'F', 1)
        self.dijkstra4.adicionaAresta('a6', 'E', 'G', 2)
        self.dijkstra4.adicionaAresta('a7', 'D', 'K', 5)
        self.dijkstra4.adicionaAresta('a8', 'B', 'H', 2)
        self.dijkstra4.adicionaAresta('a9', 'C', 'I', 4)
        self.dijkstra4.adicionaAresta('a10', 'C', 'J', 2)

        self.dijkstra5 = MeuGrafo(['A', 'B', 'C'])
        self.dijkstra5.adicionaAresta('a1', 'A', 'B', 10)
        self.dijkstra5.adicionaAresta('a2', 'A', 'C', 1)
        self.dijkstra5.adicionaAresta('a3', 'C', 'B', 1)
    ...
    def test_dijkstra(self):
        self.assertEqual(self.dijkstra1.dijkstra('A', 'E'), ['E', 'D', 'C', 'A'])
        self.assertEqual(self.dijkstra2.dijkstra('A', 'F'), ['F', 'D', 'C', 'A'])
        self.assertEqual(self.dijkstra3.dijkstra('A', 'F'), ['F', 'D', 'B', 'A'])
        self.assertEqual(self.dijkstra4.dijkstra('A', 'J'), ['J', 'C', 'A'])
        self.assertEqual(self.dijkstra5.dijkstra('A', 'B'), ['B', 'C', 'A'])